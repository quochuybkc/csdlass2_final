...
<body>
  ...
  <div class="container" style="margin-top:50px;width:100%;padding:0px">
	...
	<div class="container">
	<div class="signIn">
		<div class="signIncap">TẠO TÀI KHOẢN</div>
		<form class="sign" id="signUp" action="" method="POST">
			
			Tên tài khoản
			<input type="text" name="username" class="col-1 uname" placeholder=" Nhập tên tài khoản">
			<span style="color: #d30f30;font-size: 12px;"></span><br>
			Mật khẩu
			<input type="password" name="pwd" class="col-1 pwd" placeholder=" Mật khẩu">
			<span style="color: #d30f30;font-size: 12px;"></span><br>
			Tên email
			<input  name="email" class="col-1 email" placeholder=" Email">
			<span style="color: #d30f30;font-size: 12px;"></span><br>

			<button style="margin-left:13%;margin-top:5px;margin-bottom:30px;background:#d30f30;color:#fff;border-radius:3px;border:none">Tạo tài khoản</button><br>
		</form>
	</div>
